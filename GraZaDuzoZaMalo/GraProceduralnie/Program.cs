...
namespace GraMonolitycznie
{
    class Program
    {
        ...
        /// <exception cref="lalala">kiedy się pojawia?</exception>
        ...
        /// <summary>
        /// Wczytuję z konsoli liczbę lub znak x
        /// </summary>
        /// <returns>liczba całkowita odpowiadająca podnej wartości na konsoli</returns>
        ...
        {//wziąć w try catch !!!
            ...
            do
            {
                ...
                {
                    Console.WriteLine("Szkoda że tak szybko kończymy. See ya!");
                    return;
                }
